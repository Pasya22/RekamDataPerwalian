    ...
    <div class="row mb-5">
        <div class="col-md-2 mb-1">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control form-control-sm" id="cacademic_year" name="key" maxlength="9"
                    autocomplete="off" value="2021/2022">
            </div>
            <!-- <div class="form-group">
            ...
            <button type="submit" name="cfilter" id="search-btn" value="Filter"
            ...
            <table class="table table-striped table-hover table-sm" id="tabelData">
                ...
                <tbody id="table_data">
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="btn btn-info" href="<?= site_url('Welcome/Detail/') . $rm->npm; ?>">Detail</a>
                        </td>
                    </tr>
                    <?php } ?>
                </tbody>
            ...
            success: function(html) {
                ...
                for (let index = 0; index < html.length; index++) {
                    ...
                    data += '<tr valign="top">' +
                        ...
                        '<td> ' +
                        ' <a class="btn btn-info" href=" <?= site_url('Welcome/Detail'); ?>' +
